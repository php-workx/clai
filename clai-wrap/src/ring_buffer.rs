...
mod tests {
    ...
    fn test_thread_safety() {
        ...
        // Split into producer and consumer parts for thread-safe access
        // We'll use channels to coordinate since SpscRingBuffer isn't Send as-is
        ...
        // Also test that we can still use the original buffer
        drop(buffer);
    }
