...
complete -c footprint -s a -d 'target all processes and report system-level auxiliary data'
...
complete -c footprint -l vmObjectDirty -d 'interpret dirty memory as viewed by Virtual Memory subssytem (VM) objects in …'
