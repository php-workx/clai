# cwebp
# Autogenerated from man page /opt/homebrew/share/man/man1/cwebp.1
...
complete -c cwebp -o resize_mode -d 'Specify the behavior of the -resize option'
...
complete -c cwebp -o sharp_yuv -d 'Use more accurate and sharper RGB->YUV conversion'
