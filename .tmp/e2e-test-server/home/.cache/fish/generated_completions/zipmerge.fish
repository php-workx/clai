# zipmerge
# Autogenerated from man page /opt/homebrew/share/man/man1/zipmerge.1
...
complete -c zipmerge -s S -d 'Do not overwrite files that have the same name, size, and CRC32 in both the s…'
complete -c zipmerge -s s -d 'When i is given, do not ask before overwriting files that have the same name,…'
