# tree
# Autogenerated from man page /opt/homebrew/share/man/man1/tree.1
...
complete -c tree -s I -d 'Do not list those files or directories that match the wild-card pattern'
...
complete -c tree -l condense -d 'Condenses the output of directory \'singletons\' -- directories that themselves…'
