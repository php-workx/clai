# unxz
# Autogenerated from man page /opt/homebrew/share/man/man1/unxz.1
...
complete -c unxz -l no-sync -d 'Do not synchronize the target file and its directory to the storage device be…'
...
complete -c unxz -l filters -d 'Specify the full filter chain or a preset in a single option'
complete -c unxz -l filters1 -l filters9 -d 'Specify up to nine additional filter chains that can be used with  --block-li…'
complete -c unxz -l filters-help -d 'Display a help message describing how to specify presets and custom filter ch…'
complete -c unxz -l lzma2 -d 'PD Add LZMA1 or LZMA2 filter to the filter chain'
complete -c unxz -l riscv -d 'PD Add a branch/call/jump (BCJ) filter to the filter chain'
...
complete -c unxz -l filters3 -d 'and 2 MiB input o 3 The filter chain specified by'
complete -c unxz -l filters2 -d 'and 4 MiB input o 3 The filter chain specified by'
