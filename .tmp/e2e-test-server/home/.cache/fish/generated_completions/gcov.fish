...
complete -c gcov -o show-mcdc -d 'Show modified condition/decision coverage (MC/DC) for each applicable boolean…'
...
complete -c gcov -o show-directory-coverage -d 'Generate an index file in each directory that contains at least one source fi…'
...
complete -c gcov -o check-binary-ids -d 'Fail if an object file cannot be found for a binary ID present in the profile…'
...
complete -c gcov -o show-mcdc-summary -d 'Show MC/DC statistics.  Defaults to false'
