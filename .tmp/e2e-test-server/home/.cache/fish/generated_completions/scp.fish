# scp
# Autogenerated from man page /usr/share/man/man1/scp.1
...
complete -c scp -s R -d 'Copies between two remote hosts are transferred through the local host by def…'
