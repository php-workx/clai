# pg_receivewal
# Autogenerated from man page /opt/homebrew/share/man/man1/pg_receivewal.1
...
complete -c pg_receivewal -s S -d 'Require pg_receivewal to use an existing replication slot (see Section27. 2'
