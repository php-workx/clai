# ssh-add
# Autogenerated from man page /usr/share/man/man1/ssh-add.1
...
complete -c ssh-add -s N -d 'When adding certificates, by default ssh-add will request that the agent auto…'
